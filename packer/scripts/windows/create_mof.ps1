...
# Uses local STIG 2.1 XML generated by install_dsc_deps.ps1
...
# Use the XML generated by install_dsc_deps.ps1
...
if (!(Test-Path $OrgSettings)) {
    ...
    Write-Error "Ensure install_dsc_deps.ps1 has been run successfully."
    exit 1
}
