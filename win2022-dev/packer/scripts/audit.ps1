...
.SYNOPSIS
    ...
    NOTE: auditpol settings apply to the current running system. For persistence
    across image capture/reboot, these policies should be enforced via domain
    Group Policy (GPO) applied at first boot. This script ensures the settings
    are correct during the Packer build for DSC compliance audit purposes.
#>
