...
# V-254457 — Here-string use karo taaki newlines properly set hon
$bannerText = @"
WARNING_____WARNING
...
# Windows registry ke liye CRLF ensure karo
$bannerText = $bannerText -replace "`r`n", "`n" -replace "`n", "`r`n"
